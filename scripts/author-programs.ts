...
const housewarming: Program = {
  ...
  run_of_show: {
    ...
    main_track: [
      ...
      { id: "arrival", label: "Participants arrive and are seated", duration: 10,
        details: ["Teams pre-assigned and mixed across departments"] },
      { id: "opening", label: "Opening remarks: client executive", duration: 5 },
      { id: "content", label: "Be Legendary content block", duration: 15,
        details: ["Connection Points woven in per the sponsor's objectives"] },
      { id: "build", label: "Build the animal homes", duration: 25,
        details: ["One home per team", "Build instructions and client brief sheet issued", "No mention of the animals"] },
      { id: "reveal", label: "The Reveal: the group hits its goal and the animals arrive", duration: 5, is_anchor: true },
      { id: "present", label: "Teams meet the animals and present the homes", duration: 15,
        details: ["Handlers stay with the animals throughout", "Roaming photography"] },
      { id: "photo", label: "Group photograph", duration: 5 },
      { id: "reset", label: "Room reset for the debrief", duration: 3 },
      { id: "debrief", label: "Debrief, facilitated", duration: 10,
        details: ["What happened, so what, now what"] },
      { id: "close", label: "Close: client executive", duration: 4 },
...
const getOnBoard: Program = {
  ...
  run_of_show: {
    ...
    main_track: [
      ...
      { id: "arrival", label: "Participants arrive and are seated", duration: 15 },
      { id: "opening", label: "Opening remarks: client executive", duration: 5 },
      { id: "content", label: "Be Legendary content block: change", duration: 25,
        details: ["The parts bag arrives with no instructions on purpose", "Connection Points woven in per the sponsor's objectives"] },
      { id: "build", label: "Assemble the skateboards", duration: 30,
        details: ["A bag of parts, no instructions", "Teams work out the sequence themselves", "No mention of the children"] },
      { id: "reveal", label: "The Reveal: the children enter", duration: 5, is_anchor: true },
      { id: "present", label: "Teams present the boards, fit helmets, ride with the children", duration: 20,
        details: ["Roaming photography throughout"] },
      { id: "photo", label: "Group photograph", duration: 5 },
      { id: "tunnel", label: "Human tunnel", duration: 3 },
      { id: "reset", label: "Room reset for the debrief", duration: 3 },
      { id: "debrief", label: "Debrief: what changed and when you noticed", duration: 10 },
      { id: "close", label: "Close: client executive", duration: 4 },
...
const sixtySeconds: Program = {
  ...
  run_of_show: {
    ...
    main_track: [
      ...
      { id: "opening", label: "Opening remarks: client executive", duration: 5 },
      { id: "brief", label: "Host sets the format and the stakes", duration: 10,
        details: ["Every win triggers a real donation", "The causes are named up front"] },
      { id: "rounds", label: "Sixty-second challenge rounds", duration: 55,
        details: ["Teams race the clock", "Running donation total on the scoreboard"] },
      { id: "totals", label: "The totals are read out", duration: 10, is_anchor: true,
        details: ["What the room raised, by cause"] },
      { id: "debrief", label: "Debrief and close: client executive", duration: 10 },
